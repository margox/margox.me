~function(){
    ...
    var mobileHeader = $('.blog-header-mobile');
    $('.btn-toggle-mobile-menu').on('click', function() {
        mobileHeader.toggleClass('show-menu');
    });
    $('.btn-toggle-mobile-searcher').on('click', function() {
        mobileHeader.toggleClass('show-searcher');
    });
    ...
    $('.post-audio-obj').each(function() {
        ...
        var player_obj = new Audio();//$(this)[0];
